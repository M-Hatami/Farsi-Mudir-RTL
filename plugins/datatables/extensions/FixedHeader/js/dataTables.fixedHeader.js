  ...
  var factory = function ($, DataTable) {
    ...
    FixedHeader = function (mTable, oInit) {
      ...
      if (!this instanceof FixedHeader) {
        alert(
          "FixedHeader warning: FixedHeader must be initialised with the 'new' keyword."
        );
        return;
      }
    ...
    FixedHeader.prototype = {
      ...
      _fnMeasure: function () {
        var s = this.fnGetSettings(),
          ...
          iParentScrollTop = this._fnSumScroll(
            s.nTable.parentNode,
            "scrollTop"
          ),
          iParentScrollLeft = this._fnSumScroll(
            s.nTable.parentNode,
            "scrollLeft"
          );
        ...
        m.iTableBottom =
          FixedHeader.oDoc.iHeight - m.iTableTop - m.iTableHeight;
      },
      ...
      _fnScrollHorizontalRight: function (oCache) {
        ...
        if (oWin.iScrollRight < oMes.iTableRight) {
          ...
          oMes.iTableLeft <
          oDoc.iWidth - oWin.iScrollRight - iFixedWidth
        ) {
          /* Middle */
          this._fnUpdateCache(
            oCache,
          ...
          this._fnUpdateCache(
            oCache,
            "sTop",
            oMes.iTableTop - oWin.iScrollTop + "px",
            "top",
            nTable.style
          );
          this._fnUpdateCache(
      ...
      _fnScrollHorizontalLeft: function (oCache) {
        ...
        if (oWin.iScrollLeft < oMes.iTableLeft) {
          ...
          oWin.iScrollLeft <
          oMes.iTableLeft + oMes.iTableWidth - iCellWidth
        ) {
          this._fnUpdateCache(
            oCache,
            "sPosition",
      ...
      _fnScrollFixedFooter: function (oCache) {
        ...
        if (oWin.iScrollBottom < oMes.iTableBottom) {
          ...
          oWin.iScrollBottom <
          oMes.iTableBottom + oMes.iTableHeight - iCellHeight - iTheadHeight
        ) {
          this._fnUpdateCache(
            oCache,
            "sPosition",
      ...
      _fnScrollFixedHeader: function (oCache) {
        ...
        if (oMes.iTableTop > oWin.iScrollTop + s.oOffset.top) {
          ...
          oWin.iScrollTop + s.oOffset.top >
          oMes.iTableTop + iTbodyHeight
        ) {
          ...
          this._fnUpdateCache(
            oCache,
            "sTop",
            oMes.iTableTop + iTbodyHeight + "px",
            "top",
            nTable.style
          );
          this._fnUpdateCache(
      ...
      _fnClassUpdate: function (source, dest) {
        ...
        if (
          source.nodeName.toUpperCase() === "TR" ||
