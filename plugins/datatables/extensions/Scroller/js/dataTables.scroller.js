    ...
    Scroller.prototype = /** @lends Scroller.prototype */ {
      ...
      _fnDrawCallback: function () {
        ...
        if (displayStart === 0) {
          ...
          iScrollTop =
            heights.scroll - (displayEnd - this.s.topRowFloat) * heights.row;
        } else {
