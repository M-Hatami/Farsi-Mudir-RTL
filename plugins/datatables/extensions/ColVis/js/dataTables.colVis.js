    ...
    ColVis.prototype = {
      ...
      _fnConstruct: function (init) {
        ...
        this.dom.button = $("<button />", {
          ...
          .bind(
            this.s.activate == "mouseover" ? "mouseover" : "click",
            function (e) {
              e.preventDefault();
         ...
         */
        $(this.s.dt.oInstance).bind(
          "column-reorder.dt",
          function (e, oSettings, oReorder) {
            for (i = 0, iLen = that.s.aiExclude.length; i < iLen; i++) {
              that.s.aiExclude[i] =
                oReorder.aiInvertMapping[that.s.aiExclude[i]];
            }
      ...
      _fnDrawCallback: function () {
        ...
        for (var i = 0, ien = buttons.length; i < ien; i++) {
          ...
          if (button.__columnIdx !== undefined) {
            $("input", button).prop(
              "checked",
              columns[button.__columnIdx].bVisible
            );
          }
        }
      ...
      _fnDomRestoreButton: function () {
        ...
        return $(
          '<li class="ColVis_Special ' +
            (dt.bJUI ? "ui-button ui-state-default" : "") +
            '">' +
            this.s.restore +
            "</li>"
        ).click(function (e) {
      ...
      _fnDomColumnButton: function (i) {
        ...
        return $(
          "<li " +
            (dt.bJUI ? 'class="ui-button ui-state-default"' : "") +
            ">" +
            "<label>" +
            '<input type="checkbox" />' +
            "<span>" +
    ...
    ColVis.fnRebuild = function (oTable) {
      ...
      for (var i = 0, iLen = ColVis.aInstances.length; i < iLen; i++) {
        if (
          ...
          nTable == ColVis.aInstances[i].s.dt.nTable
        ) {
    ...
    if (
      ...
      $.fn.dataTableExt.aoFeatures.push({
        fnInit: function (oDTSettings) {
          ...
          var colvis = new ColVis(
            oDTSettings,
            init.colVis || init.oColVis || {}
          );
