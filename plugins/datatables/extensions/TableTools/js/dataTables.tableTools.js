  ...
  var factory = function ($, DataTable) {
	 ...
	 */
        ...
        fnSelectAll: function (filtered) {
          this._fnRowSelect(filtered ? this.s.dt.aiDisplay : this.s.dt.aoData);
        },
        ...
        _fnButtonDefinations: function (buttonSet, wrapper) {
          ...
          for (var i = 0, iLen = buttonSet.length; i < iLen; i++) {
            if (typeof buttonSet[i] == "string") {
              ...
              if (
                typeof TableTools.BUTTONS[buttonSet[i].sExtends] == "undefined"
              ) {
                alert(
                  "TableTools: Warning - unknown button type: " +
                    buttonSet[i].sExtends
                );
                continue;
              }
              var o = $.extend(
                {},
                TableTools.BUTTONS[buttonSet[i].sExtends],
                true
              );
        ...
        _fnButtonBase: function (o, bCollectionButton) {
          ...
          nButton.setAttribute(
            "id",
            "ToolTables_" + this.s.dt.sInstance + "_" + masterS.buttonCounter
          );
        ...
        _fnCollectionConfig: function (nButton, oConfig) {
          var nHidden = document.createElement(
            this.s.tags.collection.container
          );
        ...
        _fnCollectionShow: function (nButton, oConfig) {
          ...
          nBackground.style.height =
            (iWinHeight > iDocHeight ? iWinHeight : iDocHeight) + "px";
          nBackground.style.width =
            (iWinWidth > iDocWidth ? iWinWidth : iDocWidth) + "px";
          ...
          if (iDivY + iDivHeight > iDocHeight) {
            nHidden.style.top =
              iDivY - iDivHeight - $(nButton).outerHeight() + "px";
          }
              ...
              function (e) {
                ...
                if (select.type == "os") {
                  if (e.ctrlKey || e.metaKey) {
                    ...
                    if (
                      that.fnIsSelected(row) &&
                      that.fnGetSelected().length === 1
                    ) {
                      that._fnRowDeselect(row, e);
                    } else {
                      that.fnSelectNone();
        ...
        _fnFlashConfig: function (nButton, oConfig) {
          ...
          if (oConfig.sAction == "flash_save") {
            ...
            flash.setCharSet(
              oConfig.sCharSet == "utf16le" ? "UTF16LE" : "UTF8"
            );
            flash.setBomInc(oConfig.bBomInc);
            flash.setFileName(
              oConfig.sFileName.replace("*", this.fnGetTitle(oConfig))
            );
        ...
        _fnGetDataTablesData: function (oConfig) {
          ...
          var bSelectedOnly =
            typeof oConfig.bSelectedOnly != "undefined"
              ? oConfig.bSelectedOnly
              : false;
          ...
          if (oConfig.bHeader) {
            ...
            for (i = 0, iLen = dt.aoColumns.length; i < iLen; i++) {
              if (aColumnsInc[i]) {
                sLoopData = dt.aoColumns[i].sTitle
                  .replace(/\n/g, " ")
                  .replace(/<.*?>/g, "")
                  .replace(/^\s+|\s+$/g, "");
                ...
                aRow.push(
                  this._fnBoundData(sLoopData, oConfig.sFieldBoundary, regex)
                );
              }
            }
          ...
          for (j = 0, jLen = aDataIndex.length; j < jLen; j++) {
            ...
            for (i = 0, iLen = dt.aoColumns.length; i < iLen; i++) {
              if (aColumnsInc[i]) {
                ...
                var mTypeData = dt.oApi._fnGetCellData(
                  dt,
                  aDataIndex[j],
                  i,
                  "display"
                ...
                if (oConfig.fnCellRender) {
                  sLoopData =
                    oConfig.fnCellRender(mTypeData, i, tr, aDataIndex[j]) + "";
          ...
          if (oConfig.bFooter && dt.nTFoot !== null) {
            ...
            for (i = 0, iLen = dt.aoColumns.length; i < iLen; i++) {
              if (aColumnsInc[i] && dt.aoColumns[i].nTf !== null) {
                sLoopData = dt.aoColumns[i].nTf.innerHTML
                  .replace(/\n/g, " ")
                  .replace(/<.*?>/g, "");
                sLoopData = this._fnHtmlDecode(sLoopData);
        ...
        _fnBoundData: function (sData, sBoundary, regex) {
          if (sBoundary === "") {
            ...
            return (
              sBoundary +
              sData.replace(regex, sBoundary + sBoundary) +
              sBoundary
            );
          }
        },
        ...
        _fnPrintStart: function (oConfig) {
          ...
          for (var cFeature in anFeature) {
            if (cFeature != "i" && cFeature != "t" && cFeature.length == 1) {
              for (
                var i = 0, iLen = anFeature[cFeature].length;
                i < iLen;
                i++
              ) {
        ...
        _fnPrintScrollStart: function () {
          var oSetDT = this.s.dt,
            nScrollHeadInner =
              oSetDT.nScrollHead.getElementsByTagName("div")[0],
            nScrollHeadTable =
        ...
        _fnPrintScrollEnd: function () {
          ...
          if (oSetDT.oScroll.sX !== "") {
            nScrollBody.style.width = oSetDT.oApi._fnStringToCss(
              oSetDT.oScroll.sX
            );
          ...
          if (oSetDT.oScroll.sY !== "") {
            nScrollBody.style.height = oSetDT.oApi._fnStringToCss(
              oSetDT.oScroll.sY
            );
            nScrollBody.style.overflow = "auto";
          }
      ...
      TableTools.fnGetInstance = function (node) {
        ...
        for (var i = 0, iLen = TableTools._aInstances.length; i < iLen; i++) {
          if (
            TableTools._aInstances[i].s.master &&
            TableTools._aInstances[i].dom.table == node
          ) {
      ...
      TableTools._fnEventDispatch = function (that, type, node, selected) {
        ...
        for (var i = 0, iLen = listeners.length; i < iLen; i++) {
          if (
            that.dom.table == listeners[i].that.dom.table &&
      ...
      TableTools.buttonBase = {
        ...
        sNewLine: "auto",
        mColumns:
          "all" /* "all", "visible", "hidden" or array of column integers */,
        bHeader: true,
        bFooter: true,
        bOpenRows: false,
        bSelectedOnly: false,
      ...
      TableTools.BUTTONS = {
        ...
        print: $.extend({}, TableTools.buttonBase, {
          sInfo:
            "<h6>Print view</h6><p>Please use your browser's print function to " +
    ...
    if (
      ...
      $.fn.dataTableExt.aoFeatures.push({
        fnInit: function (oDTSettings) {
          var oOpts =
            typeof oDTSettings.oInit.oTableTools != "undefined"
